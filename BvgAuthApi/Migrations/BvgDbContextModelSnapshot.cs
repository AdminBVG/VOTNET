...
namespace BvgAuthApi.Migrations
{
    ...
    partial class BvgDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BvgAuthApi.Models.Election", b =>
            {
                    ...
                    b.Property<DateTimeOffset?>("RegistrationOpenedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("RegistrationClosedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("VotingOpenedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("VotingClosedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("BvgAuthApi.Models.VoteRecord", b =>
                {
                    ...
                    b.HasIndex("ElectionId", "PadronEntryId", "ElectionQuestionId")
                        .IsUnique();
